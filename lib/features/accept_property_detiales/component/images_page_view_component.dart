...
import 'package:manzal_office/features/accept_property_detiales/full_screen_image.dart';
...
class ImagesPageViewComponent extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<AcceptPropertyDetailsCubit, AcceptPropertyDetailsState>(
  builder: (context, state) {
    var cubit = AcceptPropertyDetailsCubit.get(context);
