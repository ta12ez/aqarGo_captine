...
import '../../../core/controller/payment_controller/payment_cubit.dart';

class YearSubscription extends StatelessWidget {
  const YearSubscription({super.key});
      ...
      child: Padding(
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              Text("Year Subscription",style: Theme.of(context).textTheme.titleMedium,),
              SizedBox(height: screenHeight(context)*0.05,),
              BillItem(firstText: "100\$", secondText: "per year", iconData: Icons.monetization_on),
              Divider(),
              BillItem(firstText: "50", secondText: "Point", iconData: Icons.control_point_outlined),
              Divider(),
              ...
              BlocBuilder<SubscriptionCubit, SubscriptionState>(
                ...
                builder: (context, state) {
                  ...
                  return state is SubscriptionLoadingState ? CircularProgressIndicator(color: mainColor1,):ButtomComponent(text: 'Subscribe Yearly', onPressed: () {
                    cubit.yearlySubscipe();
                  });
                },
              ),
            ],
